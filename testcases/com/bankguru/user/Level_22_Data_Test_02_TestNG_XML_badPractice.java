...
public class Level_22_Data_Test_02_TestNG_XML_badPractice extends AbstractTest {
	WebDriver driver;
...
//		driver = getBrowserDriver(browserName , appUrl);
	...
	@Test
	public void TC_01_Register_To_System(String emailAddress1) {
		// Input to Email textbox
		emailAddress1 = emailAddress1 + GetrandomNumber() + "@gmail.com";
		log.info("Register - step 01: Input to 'Email' textbox with value: " + emailAddress1);
		registerPage.inputToEmailTextBox(emailAddress1);
	...
	@Parameters({"fullName", "street", "emailAddress", "phone", "city"})
	@Test
	public void TC_03_New_Customer(String fullname2, String street2, String emailAddress1, String phone2, String city2) {
		...
		log.info("New Customer - step 02: Input to Fullname textbox with value: " + fullname2);
		newCustomerPage.inputToTextboxByNameAttribute(driver, "name", fullname2);
		
		log.info("New Customer - step 03: Input to Street  textbox with value: " + street2);
		newCustomerPage.inputToTextAreaByNameAttribute(driver, "addr", street2);
		
		emailAddress1 = emailAddress1 + GetrandomNumber() + "@gmail.com";
		log.info("New Customer - step 04: Input to Email Name textbox with value: " + emailAddress1);
		newCustomerPage.inputToTextboxByNameAttribute(driver, "emailid", emailAddress1 );
		
		log.info("New Customer - step 05: Input to Phone textbox with value: " + phone2);
		newCustomerPage.inputToTextboxByNameAttribute(driver, "telephoneno", phone2);
		
		log.info("New Customer - step 06: Input to City textbox with value: " + city2);
		newCustomerPage.inputToTextboxByNameAttribute(driver, "city", city2);
