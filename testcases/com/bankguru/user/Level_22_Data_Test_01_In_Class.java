...
public class Level_22_Data_Test_01_In_Class extends AbstractTest {
	WebDriver driver;
	DataHelper data = DataHelper.getData();

	// Khai báo biến toàn cục để dùng chung:
	String loginPageUrl, emailAddress, userID, password;
	String fullname, street, companyName, state, pin, phone;
	String customerName, genderMale, dateOfBirth, address, city;
...
//		driver = getBrowserDriver(browserName , appUrl);
	...
	public void beforeClass(String browserName) {
		...
		// Faker Libraries (different every run)
	...
	public void TC_03_New_Customer() {
		...
		log.info("New Customer - step 02: Input to Fullname textbox with value: " + fullname);
		newCustomerPage.inputToTextboxByNameAttribute(driver, "name", fullname );
		
		log.info("New Customer - step 03: Input to Street  textbox with value: " + street);
		newCustomerPage.inputToTextAreaByNameAttribute(driver, "addr", street);
		...
		log.info("New Customer - step 05: Input to Phone textbox with value: " + phone);
		newCustomerPage.inputToTextboxByNameAttribute(driver, "telephoneno", phone );
		
		log.info("New Customer - step 06: Input to City textbox with value: " + city);
