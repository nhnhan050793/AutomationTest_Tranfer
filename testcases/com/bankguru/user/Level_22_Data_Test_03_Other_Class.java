...
//		driver = getBrowserDriver(browserName , appUrl);
	...
	public void beforeClass(String browserName) {
		...
		emailAddress = payment.NewCustomer.PRE_EMAIL_ADDRESS + GetrandomNumber() + payment.NewCustomer.POST_EMAIL_ADDRESS;
	...
	public void TC_03_New_Customer() {
		...
		log.info("New Customer - step 02: Input to Fullname textbox with value: " + payment.NewCustomer.FULLNAME);
		newCustomerPage.inputToTextboxByNameAttribute(driver, "name", payment.NewCustomer.FULLNAME );
		
		log.info("New Customer - step 03: Input to Street  textbox with value: " + payment.NewCustomer.STREET_ADDRESS);
		newCustomerPage.inputToTextAreaByNameAttribute(driver, "addr", payment.NewCustomer.STREET_ADDRESS);
		...
		log.info("New Customer - step 05: Input to Phone textbox with value: " + payment.NewCustomer.PHONE_NUMBER);
		newCustomerPage.inputToTextboxByNameAttribute(driver, "telephoneno", payment.NewCustomer.PHONE_NUMBER );
		
		log.info("New Customer - step 06: Input to City textbox with value: " + payment.NewCustomer.CITY);
		newCustomerPage.inputToTextboxByNameAttribute(driver, "city", payment.NewCustomer.CITY );
